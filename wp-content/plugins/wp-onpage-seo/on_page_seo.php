...
/*
Plugin Name: OnPage SEO Tool
Plugin URI: https://usefulblogging.com/wp-on-page-seo-plugin
Description: Increase Web Traffic by Using WP OnPage SEO Tool and Get the First Page on Google.
Author: Ataul Ghani
Version: 2.2
...
//------------------------------------------------------------------------------
    ...
    * User-friendly title
    */
    const TITLE = 'WP OnPage SEO Tool';

    /**
    * Menu item text
    */
    const MENU_LABEL = 'OnPage SEO';
