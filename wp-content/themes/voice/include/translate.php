...
$vce_translate = array(
	...
	'more' => array('option_title' => 'More', 'translated' => __('More', THEME_SLUG), 'option_desc' => 'More link label in responsive navigation if option to display top bar navigation under one group is enabled'),
);
